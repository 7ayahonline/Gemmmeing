...
This version is configured for GitHub Pages static hosting. Enable **Settings → Pages → GitHub Actions**. The included workflow builds the Next.js static export and deploys `out/` automatically.
